...
{           
    ...
    {
        public /*internal readonly*/Dictionary<K, V> baseDictionary = new Dictionary<K, V>();
        public /*internal readonly*/Dictionary<L, K> subDictionary = new Dictionary<L, K>();
        public /*internal readonly*/ Dictionary<K, L> primaryToSubkeyMapping = new Dictionary<K, L>();
